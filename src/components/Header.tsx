...
const Header = () => {
  return (
    <header className="fixed top-0 w-full bg-background/95 backdrop-blur-sm z-50 border-b border-warm-secondary/30">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">Hearthside Manor</h1>
            <p className="text-sm text-muted-foreground">Assisted Living</p>
          </div>
        </div>
