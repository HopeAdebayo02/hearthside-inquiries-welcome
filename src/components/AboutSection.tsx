      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed mb-8">
            At Hearthside Manor, we believe that assisted living should feel like an extension of home, 
            not an institution. Our family-founded facility has been serving the community for over 15 years, 
            providing compassionate care that honors the dignity and independence of every resident.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {stats.map((stat, index) => (
            <Card key={index} className="text-center border-warm-secondary/30 bg-background hover:shadow-[var(--shadow-soft)] transition-all duration-300">
              <CardHeader>
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-muted-foreground mt-4">
            Experience the Hearthside Manor difference in person
          </p>
        </div>
      </div>
    </section>
